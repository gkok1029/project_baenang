...
<script>
	function confirmDelete() {
		if (confirm("정말 삭제하시겠습니까?")) {
			...
			location.href = '/user/blog/remove?p_id=<c:out value="${post.p_id}"/>';
		} else {
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-body">
								...
								<div class="form-group">
									<label>엽서번호</label> <input class="form-control" name='p_id'
						...
						<li
							...
							<div style="margin: 30px;">
								...
								<button class="btn btn-danger"
									onclick="location.href='/replies/remove?r_id=<c:out value="${reply.r_id}"/>'">삭제</button>
